...
define('XML_FILE_FOLDER',PATH_ROOT . 'rsync_xml_ok/');
define('SYNC_RESULT_FOLDER','/home/');
define('SYNC_FILE_FOLDER','/home/');//include slash('/') at the end
define('Local_Chroot','/home/');// browse server's root path
define('NFS_SERVER','192.168.2.40');
session_start();
