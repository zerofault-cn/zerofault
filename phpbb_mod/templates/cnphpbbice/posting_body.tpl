...
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[list=]','[/list]','[img]','[/img]','[url]','[/url]','[intro]','[/intro]');
imageTag = false;
...
<option selected value="">帖类型</option> 
...
<option value="[其它]">[其它]</option> 
		...
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr> 
			<td colspan="9"><span class="gen"> 
			  <textarea name="message" rows="15" cols="35" wrap="virtual" style="width:450px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);" onkeydown="ctrlenter(event);">{MESSAGE}</textarea>
			  </span></td>
		  </tr>
		</table>
		</span></td>
	...
	<tr> 
	  ...
	  <td class="row2"><span class="gen"> </span> 
		...
		{ATTACHBOX}{POLLBOX} 
	<tr> 
	  <td class="catBottom" colspan="2" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" id = "postc" /></td>
	</tr>
  </table>
