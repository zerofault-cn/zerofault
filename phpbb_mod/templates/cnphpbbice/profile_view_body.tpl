...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	<td class="row1" height="150" valign="top" align="center">{AVATAR_IMG}<br /><span class="postdetails">{POSTER_RANK}</span></td>
			...
			<td> 
				...
				<tr> 
					<td colspan="3" width="100%" class="row2">
						...
						<tr> 
							<td bgcolor="{T_TD_COLOR2}"><img src="templates/cnphpbbice/images/spacer.gif" width="{UPLOAD_LIMIT_IMG_WIDTH}" height="8" alt="{UPLOAD_LIMIT_PERCENT}" /></td>
						</tr>
						</table>
					</td>
				</tr>
