...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<!-- BEGIN forumrow -->
	<tr> 
		<td class="row2"><table width="100%" cellpadding="0" cellspacing="3" border="0"><tr><td>{catrow.forumrow.FORUM_ICON}</td><td width="100%"><span class="gen"><a href="{catrow.forumrow.U_VIEWFORUM}" target="_new">{catrow.forumrow.FORUM_NAME}</a></span><br /><span class="gensmall">{catrow.forumrow.FORUM_DESC}</span></td></tr></table></td>
		...
		<td class="row1" align="center" valign="middle"><span class="gen"><a href="{catrow.forumrow.U_FORUM_MOVE_UP}">{L_MOVE_UP}</a> <br /> <a href="{catrow.forumrow.U_FORUM_MOVE_DOWN}">{L_MOVE_DOWN}</a>{catrow.forumrow.FORUM_SUB}</span></td>
	...
	<tr>
		<td colspan="7" height="1" class="spaceRow"><img src="../templates/cnphpbbice/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END catrow -->
	<tr>
