...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		<td class="row1"><span class="gen">{L_REMOVE_TOPICS}</span> <select name="prune_topic_started"><option value="true" selected="selected">{L_YES}</option><option value="false">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_REMOVE_TOPICS_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EXEMPT_STICKIES}</span> <select name="prune_stickies"><option value="true">{L_YES}</option><option value="false" selected="selected">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_EXEMPT_STICKIES_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EXEMPT_ANNOUNCEMENTS}</span> <select name="prune_announcements"><option value="true">{L_YES}</option><option value="false" selected="selected">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_EXEMPT_ANNOUNCEMENTS_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EXEMPT_OPEN}</span> <select name="prune_open"><option value="true">{L_YES}</option><option value="false" selected="selected">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_EXEMPT_OPEN_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EXEMPT_POLLS}</span> <select name="prune_polls"><option value="true">{L_YES}</option><option value="false" selected="selected">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_EXEMPT_POLLS_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_ADJUST_COUNTS}</span> <select name="prune_update_post_counts"><option value="true" selected="selected">{L_YES}</option><option value="false">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_ADJUST_COUNTS_EXPLAIN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_UPDATE_SEARCH}</span> <select name="prune_update_search"><option value="true" selected="selected">{L_YES}</option><option value="false">{L_NO}</option></select></td><td class="row1"></td>
	</tr>
	<tr>
