...
td.rowpic {
		...
		background-image: url(templates/cnphpbbice/images/{T_TH_CLASS3});
...
th	{
	...
	background-image: url(templates/cnphpbbice/images/{T_TH_CLASS2});
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(templates/cnphpbbice/images/{T_TH_CLASS1});
...
@import url("templates/cnphpbbice/formIE.css"); 
-->
</style>
