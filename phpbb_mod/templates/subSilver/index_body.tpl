...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	...
	<td class="row1" width="100%" height="50"><table width="100%" cellpadding="0" cellspacing="3" border="0"><tr><td>{catrow.forumrow.FORUM_ICON}</td><td width="100%"><span class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink">{catrow.forumrow.FORUM_NAME}</a><br />
	  </span><span class="genmed">{catrow.forumrow.FORUM_DESC}<br /></span>
	  <span class="gensmall">{catrow.forumrow.L_MODERATOR} {catrow.forumrow.MODERATORS} {catrow.forumrow.FORUM_NAME_SUB}</span></td></tr></table></td>
