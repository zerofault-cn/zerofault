...
<!-- BEGIN img --><img onload="setImageDimensions(this)" onmouseover="changeImageDimensions(this, 'over')" onmouseout="changeImageDimensions(this, 'out')" src="{URL}" border="0" /><!-- END img -->
