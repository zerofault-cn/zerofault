...
<!-- BEGIN attach -->
	...
	<tr>
		<td colspan="2" align="center"><br /><a href="{postrow.attach.cat_images.IMG_SRC}" target="_blank"><img src="{postrow.attach.cat_images.IMG_SRC}" {postrow.attach.cat_images.IMG_SIZE} alt="{postrow.attach.cat_images.DOWNLOAD_NAME}" border="0" /></a><br /><br /></td>
	</tr>
	</table>
	<div align="center"><hr width="95%" /></div>
	<!-- END cat_images -->
