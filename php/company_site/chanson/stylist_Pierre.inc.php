			...
			<tr>
				<td width="226" height="140" valign="bottom">
					<div class="stylist_header"><b>设　计　师</b>Pierre-Marie Gallois</div>
				</td>
				<td width="226">&nbsp;</td>
				<td width="226">&nbsp;</td>
			</tr>
			<tr>
				...
				<td rowspan="4" valign="top" bgcolor="#000000">
					<div class="stylist_intro">
						<h2><a href="?stylist"><img src="images/icon4.gif" align="absmiddle"/></a>Pierre-Marie Gallois</h2>
						<h3>职位：全球总裁</h3>
						<dl>
							<dt>个人简介：</dt>
							...
							<dd>普罗旺斯.紫餐厅</dd>
							<dt>作品风格：</dt>
							<dd>深受印象派影响，崇尚极简风格,擅长用简洁的线条中叙述人与自然的亲密关系。</dd>
						</dl>
					</div>
				</td>
				<td height="230" align="right" valign="top"><img src="images/photo_Pierre.jpg" /></td>
			</tr>
			<tr>
				<td height="90">&nbsp;</td>
			</tr>
