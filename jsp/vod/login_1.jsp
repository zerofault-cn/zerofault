...
function img_click() {
	location="login_2.jsp?account=" + account1;
}
...
function img_click_2(m,n) {
	if(shift==0)
		...
		account1 += n;
	t1 = document.getElementById("account");
	t1.innerHTML = account1;
	if(account1.length==20)
	{
		account1='';
		t1.innerHTML = account1;
	}
...
function img_click_4() {
	var account4 = account1;
	account4 = account4.substring(0,account4.length - 1);
	account1=account4;
	t1 = document.getElementById("account");
	t1.innerHTML = account1;
}
...
　	if(keycode==36)//HOME
    ...
    if(keycode==13) 
		img_click_2(m,n);
	//if(keycode==35) location="loginaccount?account=" + account1;
...
<body leftMargin=0 topMargin=0 bgcolor="#0a56d" background="file:///usr/suit/newebox/image/keyboard/login.jpg">
...
<tr>
	<td height=32 align="right"><img src="file:///usr/suit/newebox/image/keyboard/username.png" width="150" height="40"></td>
	<td class=style24b id="account" bgcolor="#ffffff"></td>
	<td></td>
</tr>
<tr>
...
<tr>
	<td colspan=3 align="center" ><a href="#" onclick="img_click()" onblur="MM_swapImgRestore()" onfocus="MM_swapImage('Image57','','file:///usr/suit/newebox/image/keyboard/queding_2.gif',1)"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image57','','file:///usr/suit/newebox/image/keyboard/queding_2.gif',1)"><img src="file:///usr/suit/newebox/image/keyboard/queding_1.gif" name="Image57" width="122" height="41" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="img_clicks_1()" onblur="MM_swapImgRestore()" onfocus="MM_swapImage('Image66','','file:///usr/suit/newebox/image/keyboard/fanhui_2.gif',1)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image66','','file:///usr/suit/newebox/image/keyboard/fanhui_2.gif',1)"><img src="file:///usr/suit/newebox/image/keyboard/fanhui_1.gif" name="Image66" width="122" height="41" border="0"></a></td>
