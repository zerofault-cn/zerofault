...
String flet = pinyin.substring(0,1);
String elet = pinyin.substring(1) + "zzzzzzzzz";
...
if(offset!=0)
{
	...
	%>
	<a href="index.jsp?content=music_prog_pinyin&var1=pinyint&value1=<%=pinyin%>&var2=offset&value2=0">【最前】</a>&nbsp;&nbsp;
	<a href="index.jsp?content=music_prog_pinyin&var1=pinyin&value1=<%=pinyin%>&var2=offset&value2=<%=preoffset%>">【前一页】</a>&nbsp;&nbsp;
	<%
}
...
if((offset+pageitem)<rowCount)
{
	...
	%>
	<a href="index.jsp?content=music_prog_pinyin&var1=pinyin&value1=<%=pinyin%>&var2=offset&value2=<%=nextoffset%>">【后一页】</a>&nbsp;&nbsp;
	<a href="index.jsp?content=music_prog_pinyin&var1=pinyin&value1=<%=pinyin%>&var2=offset&value2=<%=endpage%>">【最后】</a>&nbsp;&nbsp;
	<%
}
%>
