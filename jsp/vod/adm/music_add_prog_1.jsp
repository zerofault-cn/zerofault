...
function check()
{
	...
	if(window.document.add.pinyin.value=="")
	{
		alert("我已帮你生成拼音!");
		document.add.pinyin.value=c(document.add.prog_name.value);
		document.add.pinyin.focus();
		return false;
	}
	if(window.document.add.wordcount.value=="")
	{
		alert("我已帮你生成字数!");
		document.add.wordcount.value=document.add.prog_name.value.length;
		document.add.wordcount.focus();
		return false;
	}
...
<form action="music_add_prog_2.jsp" method=post name=add onsubmit="return check()">
...
<tr bgcolor=white>
	...
	<td><select name=singer_id onchange="document.add.select_flag.value=1">
		...
		String sql1="select singer_id,singer_name from singer_info order by type_other_id desc,binary singer_name";
...
<tr bgcolor=white>
	<td align=right><span style="color:red">*</span>歌名拼音:</td>
	<td><input type=text name=pinyin><input type=button value="<< 请点击生成拼音" onclick="javascript:this.form.pinyin.value=c(this.form.prog_name.value);"></td>
</tr>
<tr bgcolor=white>
	<td align=right><span style="color:red">*</span>歌名字数:</td>
	<td><input type=text name=wordcount><input type=button value="<< 请点击生成字数" onclick="javascript:this.form.wordcount.value=this.form.prog_name.value.length;"></td>
</tr>
<tr bgcolor=white>
