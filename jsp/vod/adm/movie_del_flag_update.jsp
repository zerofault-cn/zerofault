...
int del_flag=-1;
int r=0;
sql1="select prog_id,prog_path from prog_info where prog_name is not null and prog_path is not null and prog_kindsec=1006 and prog_path like '%.WMV' order by prog_id";
