...
<div style="width:800px;margin-top:10px;margin-left:auto;margin-right:auto;border:1px solid #000;padding:10px;">
	...
	<div id="addcate" style="border:1px dotted #bbb;padding:3px;line-height:140%;">
		...
		<div id="addCateForm">
			分类名称：<input type="text" id="cate_name" name="cate_name" size="10">
			...
			简介：<input type="text" id="cate_descr" name="cate_descr" size="40">
		</div>
	</div>
	<ol class="cate_list">
<?
		...
		<li id="<?=$val["id"]?>" class="<?=$class_arr[$val["flag"]]?>">
			...
			<ol class="site_list">
				<div class="addSiteForm" id="<?=$val["id"]?>">
					网站：<input type="text" class="site_name" name="site_name" size="10">
					...
					网址：<input type="text" class="site_url" name="site_url" size="20"><br />
					简介：<input type="text" class="site_descr" name="site_descr" size="40">
				</div>
	<?
