...
CREATE TABLE IF NOT EXISTS `bus_hz_line` (
  ...
  `term1_sid` int(10) unsigned NOT NULL DEFAULT '0' ,
  `term2_sid` int(10) unsigned NOT NULL DEFAULT '0' ,
  `term1_start` varchar(64) NOT NULL DEFAULT '' ,
  `term1_end` varchar(64) NOT NULL DEFAULT '' ,
  `term2_start` varchar(64) NOT NULL DEFAULT '' ,
  `term2_end` varchar(64) NOT NULL DEFAULT '' ,
