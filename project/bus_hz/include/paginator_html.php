...
class Paginator_html extends Paginator {
	...
	function gamingtypes() {
		...
		if($this->getCurrent()>1) { $Page_Str.="<td><a href=\"" . $this->pagename . "page=" . $this->getFirst() . "\" title=\"First Page\"><img src=\"./images/page_first.gif\" border=\"0\"></a></td>"; }
		if($this->getPrevious()) { $Page_Str.="<td><a href=\"" . $this->pagename . "page=" . $this->getPrevious() . "\" title=\"Previous Page\"><img src=\"./images/page_prev.gif\" border=\"0\"></a></td>"; }
		...
		if($this->getNext()) { $Page_Str.="<td><a href=\"" . $this->pagename . "page=" . $this->getNext() . "\" title=\"Next Page\"><img src=\"./images/page_next.gif\" border=\"0\"></a></td>"; }
		if($this->getLast()) { $Page_Str.="<td><a href=\"" . $this->pagename . "page=" . $this->getLast() . "\" title=\"Last Page\"><img src=\"./images/page_last.gif\" border=\"0\"></a></td>"; }
	...
	function trackingtypes() {
		...
		if($this->getCurrent()>1) { $Page_Str.="<td><a href=\"" . $this->pagename . "page=" . $this->getFirst() . "\" title=\"First Page\"><img src=\"./images/page_first.gif\" border=\"0\"></a></td>"; }
		if($this->getPrevious()) { $Page_Str.="<td>&nbsp;</td><td><a href=\"" . $this->pagename . "page=" . $this->getPrevious() . "\" title=\"Previous Page\"><img src=\"./images/page_prev.gif\" border=\"0\"></a></td>"; }
		...
		if($this->getNext()) { $Page_Str.="<td>&nbsp;</td><td><a href=\"" . $this->pagename . "page=" . $this->getNext() . "\" title=\"Next Page\"><img src=\"./images/page_next.gif\" border=\"0\"></a></td>"; }
		if($this->getLast()) { $Page_Str.="<td>&nbsp;</td><td><a href=\"" . $this->pagename . "page=" . $this->getLast() . "\" title=\"Last Page\"><img src=\"./images/page_last.gif\" border=\"0\"></a></td>"; }
