...
foreach($info as $row=>$line)
{
	...
	$number = 1000+intval(str_ireplace("B",'',$number));
	$number = 2000+intval(str_ireplace("B支",'',$number));
	$number = 3000+intval(str_ireplace("Y",'',$number));
	$number = 4000+intval(str_ireplace("J",'',$number));
