...
/*****************************/
var webFXTreeConfig = {
	rootIcon        : 'xtree_images/foldericon.png',
	openRootIcon    : 'xtree_images/openfoldericon.png',
	folderIcon      : 'xtree_images/foldericon.png',
	openFolderIcon  : 'xtree_images/openfoldericon.png',
	fileIcon        : 'xtree_images/file.png',
	iIcon           : 'xtree_images/I.png',
	lIcon           : 'xtree_images/L.png',
	lMinusIcon      : 'xtree_images/Lminus.png',
	lPlusIcon       : 'xtree_images/Lplus.png',
	tIcon           : 'xtree_images/T.png',
	tMinusIcon      : 'xtree_images/Tminus.png',
	tPlusIcon       : 'xtree_images/Tplus.png',
	blankIcon       : 'xtree_images/blank.png',
...
//	var action = oNode.getElementsByTagName("action")[0].firstChild.nodeValue;
	var parent = null;
	var icon='';
//	var icon = oNode.getAttribute("icon");
//	var icon = oNode.getElementsByTagName("icon")[0].firstChild.nodeValue;
	var openIcon='';
//	var openIcon = oNode.getAttribute("openIcon");
//	var openIcon = oNode.getElementsByTagName("openIcon")[0].firstChild.nodeValue;
	var src='';
//	var src = oNode.getAttribute("src");
//	var src = oNode.getElementsByTagName("src")[0].firstChild.nodeValue;
	var target='';
//	var target = oNode.getAttribute("target");
//	var target = oNode.getElementsByTagName("target")[0].firstChild.nodeValue;

	var sRadio='';
//	var sRadio = oNode.getAttribute("radio");
//	var sRadio = oNode.getElementsByTagName("radio")[0].firstChild.nodeValue;
	var sCheckbox='';
//	var sCheckbox = oNode.getAttribute("checkbox");
//	var sCheckbox = oNode.getElementsByTagName("checkbox")[0].firstChild.nodeValue;
	var sValue='';
//	var sValue = oNode.getAttribute("value");
//	var sValue = oNode.getElementsByTagName("value")[0].firstChild.nodeValue;
	var sChecked='';
//	var sChecked = oNode.getAttribute("checked");
//	var sChecked = oNode.getElementsByTagName("checked")[0].firstChild.nodeValue;
	// create jsNode
	var jsNode;
	if (src != null && src != ""){
