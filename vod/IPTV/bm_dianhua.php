<?
$txt_arr=@file("../include/cd_dianhua.txt","r");
...
for($i=0;$i<$line_count;$i++)
{
	...
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td style="color:#b3ffe1"><?=trim($line_info[$i][0])?></td><td align=right style="color:#b3ffe1"><?=trim($line_info[$i][1])?></td></tr></table>';
<?
	}
	else
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td align="center" style="color:#b3ffe1"><?=trim($line_info[$i][0])?></td></tr></table>';
<?
	}
}
?>
...
<div id="topnavi">
<span class="topnavi">常用信息：常用电话</span>
</div>
<div id="dianhua_item">
</div>
<div id="dianhua_navi">
