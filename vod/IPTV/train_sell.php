<?
$txt_arr=file("../include/train_sell.txt","r");
...
for($i=0,$j=0;$i<$line_count;$i++)
{
	...
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td style="color:#b3ffe1"><?=($j+1)?>、<?=trim($line_info[$i][0])?></td></tr></table>';
<?
	$j++;
	}
	else
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td align=center style="color:#ffcc33"><?=trim($line_info[$i][1])?></td></tr></table>';
<?
	}
}
?>
