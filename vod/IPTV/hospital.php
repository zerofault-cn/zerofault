<?
$n=$_REQUEST["n"];
$txt_arr=file("../include/hospital_".$n.".txt","r");
...
<?
	...
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td style="color:#b3ffe1"><?=($i+1)?>、<?=trim($line_info[$i][0])?></td></tr><tr><td style="color:#b3ffe1">&nbsp;&nbsp;&nbsp;<?=trim($line_info[$i][1])?></td></tr></table>';
<?
	}
	else
	{
?>
line_info[<?=$i?>]='<table width="100%" border=0 cellpadding=0 cellspacing=0 class="dianhua_item_table"><tr><td style="color:#b3ffe1"><?=($i+1)?>、<?=trim($line_info[$i][0])?></td></tr><tr><td style="color:#b3ffe1">&nbsp;&nbsp;&nbsp;<?=trim($line_info[$i][1])?></td></tr><tr><td style="color:#b3ffe1">&nbsp;&nbsp;&nbsp;<?=trim($line_info[$i][2])?></td></tr></table>';
<?
	}
}
?>
