...
<form ENCTYPE="multipart/form-data" method=post name=form1 action="mp3_add_2.php" onsubmit="return check()">
<table align=center width="100%" border=0 rules=rows cellspacing=1 cellpadding=0 bgcolor=black>
<caption>添加MP3歌曲(<span class=blue>自动上传MP3文件</span>)</caption>
<tr bgcolor=white>
