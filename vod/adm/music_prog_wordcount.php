...
if($offset!=0)
{
	...
	?>
	<a href="?content=music_prog_wordcount&wordcount=<?=$wordcount?>&offset=0">【最前】</a>&nbsp;&nbsp;
	<a href="?content=music_prog_wordcount&wordcount=<?=$wordcount?>&offset=<?=$preoffset?>">【前一页】</a>&nbsp;&nbsp;
	<?
}
...
if(($offset+$pageitem)<$rowCount)
{
	...
	?>
	<a href="?content=music_prog_wordcount&wordcount=<?=$wordcount?>&offset=<?=$nextoffset?>">【后一页】</a>&nbsp;&nbsp;
	<a href="?content=music_prog_wordcount&wordcount=<?=$wordcount?>&offset=<?=$endpage?>">【最后】</a>&nbsp;&nbsp;
	<?
}
?>
