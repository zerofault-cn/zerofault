...
<form ENCTYPE="multipart/form-data" method=post name=form1 action="mp3_add_2_to_15_3.php" onsubmit="return check()">
<table align=center width="100%" border=0 rules=rows cellspacing=1 cellpadding=0 bgcolor=black>
<caption>添加MP3歌曲(<span class=blue>自动上传MP3文件到Server15_3</span>)</caption>
<tr bgcolor=white>
	<td align=right width="21%"><span style="color:red">*</span>选择MP3文件：</td>
	<td><input type=file name="mp3file" size=38 onchange="update_info()"></td>
</tr>
<tr bgcolor=white>
	...
	<td><select name=singer_id>
		...
		?>
		</select><span class=small>(如果没有所需歌手名,请<a class=blue href="index.php?content=music_add_singer_1">添加歌手</a>)</span></td>
</tr>
<tr bgcolor=white>
...
<tr bgcolor=white>
	<td align=right colspan=2><input type=hidden name=up_flag value=1><input type=checkbox name=up_flag2 value=1 checked>立即上传&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
</tr>
<tr bgcolor=white>
	<td colspan=2>
	注意:<br>
