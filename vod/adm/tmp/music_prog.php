...
$sql1="select count(*) from prog_info,singer_info where prog_name is not null and prog_path is not null and prog_kindsec=1026 and prog_info.publisher =singer_info.singer_id";
$sql2="select prog_id,singer_id,singer_name,prog_name,prog_path,prog_indate,del_flag from prog_info,singer_info where prog_name is not null and prog_path is not null and prog_kindsec=1026 and prog_info.publisher =singer_info.singer_id order by prog_id desc,prog_path limit ".$offset.",".$pageitem;
...
if($offset!=0)
{
	...
	?>
	<a href="?content=music_prog&offset=0">【最前】</a>&nbsp;&nbsp;
	<a href="?content=music_prog&offset=<?=$preoffset?>">【前一页】</a>&nbsp;&nbsp;
	<?
}
...
if(($offset+$pageitem)<$rowCount)
{
	...
	?>
	<a href="?content=music_prog&offset=<?=$nextoffset?>">【后一页】</a>&nbsp;&nbsp;
	<a href="?content=music_prog&offset=<?=$endpage?>">【最后】</a>&nbsp;&nbsp;
	<?
}
?>
