...
$sql1="select prog_id,prog_path from prog_info where prog_name is not null and prog_path is not null and prog_kindsec=1026 and prog_path like '%.mp4' order by prog_id";
