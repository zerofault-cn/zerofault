...
<tr bgcolor=white>
	...
	while($r=mysql_fetch_array($result1))
	{
		...
		?>
		<td align=center valign=top><a href="index.php?content=music_singer_song&singer_id=<?=$singer_id?>" title="点击查看歌手详细信息"><?=$singer_name?></a><br><span class=small>(<span class=green><?=$mtv_count?></span>,<span class=blue><?=$mp3_count?></span>)</span></td>
		<?
		if($j%$col==($col-1))
		{
			echo '</tr>';
