...
$sql1="select prog_id,prog_path from prog_info where prog_name is not null and prog_path is not null and prog_kindsec=1026 and (prog_path like 'bod/server15%.wmv' or prog_path like 'bod/server15%.WMV') order by prog_id";
...
while($r=mysql_fetch_array($result1))
{
	...
	$prog_id=$r[0];
	$prog_path=$r[1];
	$realpath = "/dpfs/".getRealPath($prog_path);
