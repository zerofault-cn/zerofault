...
<tr>
	...
	<!-- <td><?=$user_account?>&nbsp;</td> -->
	<td><a href="javascript:void(0)" onclick="window.open('user_info.php?my_id=<?=$_COOKIE['cookie_user_id']?>&user_id=<?=$user_id?>','','width=450,height=320,toolbar=no,status=no,scrollbars=yes,resizable=no');" title="点击查看 <?=$user_name?> 的详细资料"><b><?=$user_name?></b></a>&nbsp;</td>
	<td>
	<?
	if($user_sex=='男')
	{
