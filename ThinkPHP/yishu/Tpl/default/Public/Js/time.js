...
function weekday(){
    var cl = '<font style="font-size:14px"';
...
var sFtv = new Array("0101*元旦","0214 情人节","0308 妇女节","0312 植树节","0401 愚人节","0501 劳动节","0504 青年节","0512 护士节","0601 儿童节","0701 建党节","0801 建军节","0811 记者日","0910 教师节","1001*国庆节","1101 万圣节","1225 圣诞节","0513 母亲节","0617 父亲节","1129 感恩节")
...
if (mm < 10) hh+='0'
hh += mm
var str='<a href="http://www.11451.cn/tools/wannianli.htm"  title="点击打开万年历" target=_blank>'+YYMMDD()+' '+weekday()+" <span id=ClockTime>"+hh+"</span> "+solarDay()+'</a>'
