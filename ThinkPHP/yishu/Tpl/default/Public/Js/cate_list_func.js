...
function setCateNameEditable(obj,n){ //设置分类名称可编辑功能
	$(obj).css("cursor","pointer").click(function(){
		...
		html1='<span><input class="quickedit" type="text" value="'+html0+'" size="'+2*html0.length+'"> <i class="submit"><img src="'+APP_PUBLIC_URL+'/Images/sign_tick.gif" alt="提交" align="absmiddle"/></i><i class="cancel"><img src="'+APP_PUBLIC_URL+'/Images/sign_cancel.gif" alt="取消" align="absmiddle"/></i></span>';
		$(this).prev().hide();
