...
<tr bgcolor="white">
	...
	<td><input type=button onclick="window.open('album_modify_1.php?album_id=<?=$album_info[$i][0]?>','','width=450,height=490,toolbar=no,status=no,scrollbars=auto,resizable=yes');" value="修改"> <input type="button" onclick="javascript:location='song_add_1.php?singer_id=<?=$singer_id?>&album_id=<?=$album_info[$i][0]?>'" value="添加歌曲"></td>
</tr>
	<?
...
<tr bgcolor="white">
	...
	<td><input type=button onclick="window.open('song_modify_1.php?song_id=<?=$album_info[$i][5][$j][0]?>','','width=480,height=280,toolbar=no,status=no,scrollbars=auto,resizable=yes');" value= "修改" ></td>
</tr>
		<?
	}
}
