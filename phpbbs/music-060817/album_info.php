...
<tr>
	...
	<tr>
		...
		您所在位置:<a href="index.php">音乐首页</a>-&gt;<a href="singer_list.php?list_id=<?=$singer_area_id.$singer_chorus_id?>"><?=$singer_area?><?=$singer_chorus?></a>-&gt;<a href="singer_info.php?singer_id=<?=$singer_id?>"><?=$singer_name?></a>-&gt;<?=$album_name?>:
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		歌手名:<a href="singer_info.php?singer_id=<?=$singer_id?>"><?=$singer_name?></a><br>
		专辑名:<a href="album_info.php?album_id=<?=$album_id?>"><?=$album_name?></a><br>
		发布日期:<?=$album_pubdate?><br>
		关注指数:<?=$album_count?><br>
		简介:<div style="line-height:130%"><?=$album_intro?></div>
		</td>
	</tr>
	</table>
	...
	if($db->sql_numrows($result5)==0)
	{
		?>
	<tr>
		<td height=30 colspan=7 align=center>暂时没有单曲</td>
	</tr>
	<tr>
	...
	?>
	<tr>
		<td colspan=7 align=right><a href="play.php?type=album_id&value=<?=$album_id?>">|&gt;专辑连续播放&lt;|</a></td>
	</tr>
	</table>
	<?
