...
$sql1="select * from album_info where binary singer_id=".$singer_id." and album_name='".$album_name."'";
...
//	$sql2="insert into album_info values('','".$singer_id."','".$album_name."','".$album_pubdate."','".format($album_intro)."','".$photo_data."','')";
	$sql2="insert into album_info set singer_id='".$singer_id."',album_name='".$album_name."',album_pubdate='".$album_pubdate."',album_intro='".format($album_intro)."',album_photo='".$photo_data."'";
