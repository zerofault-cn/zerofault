...
$sql2="insert into song_info set singer_id='".$singer_id."',album_id='".$album_id."',song_name='".$song_name."',song_path='".$mp3filepath."',song_lyric='".$lrcfilepath."',song_addtime=CURDATE()";
