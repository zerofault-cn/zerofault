...
else
{
	...
	$sql2="insert into singer_info singer_name='".$singer_name."',singer_name_fc='".$singer_name_fc."',singer_photo='".$photo_data."',singer_intro='".format($singer_intro)."',singer_area_id='".$type_area_id."',singer_chorus_id='".$type_chorus_id."'";
