...
if($id>0)
{
	...
	$viewurl='http://beta.bobo.com.cn/bokee/zhong.php?flag=view&userid='.$id.'&bokeeURL='.$bokeeurl;
	$uploadurl=checkLogin($blogurl)?'http://beta.bobo.com.cn/bokee/zhong.php?flag=up&userid='.$id.'&bokeeURL='.$bokeeurl:'http://reg.bokee.com/account/LoginCtrl.b';
	$uploadurl='http://beta.bobo.com.cn/bokee/zhong.php?flag=up&userid=3&bokeeURL='.$bokeeurl;
	$boboimg='http://beta.bobo.com.cn/bokee/changepic.php?userid='.$id;
