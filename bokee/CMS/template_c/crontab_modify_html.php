...
<table width="80%" border="0" cellspacing="2" cellpadding="10" bgcolor="#c1d7f4" align="center">
  <tr>
    <td bgcolor="#FFFFFF"><form action="main.php?do=crontab_do_modify" name="subject_form" method="post" enctype='multipart/form-data'>
...
">
          ...
          <tr bgcolor="#FFFFFF">
            <td>内容：</td>
            <td><textarea name="content" cols="50" rows="25" type="text" ><?php
echo $_obj['content'];
?>
</textarea>              
              <?php
