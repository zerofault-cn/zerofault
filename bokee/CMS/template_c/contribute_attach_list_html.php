...
<td><a href="http://blogs.bokee.com/contribute/channel.php?id=<?php
echo $_obj['feed_id'];
?>
" target="_blank"><?php
...
<td><a href="scripts/sync_from_contribute.php?id=<?php
echo $_obj['id'];
?>
&channel_name=<?php
echo $_obj['channel_name'];
?>
" target="_blank">立即同步</a> <a href="main.php?do=feed_attach_delete&id=<?php
echo $_obj['id'];
?>
&channel_name=<?php
echo $_obj['channel_name'];
...
<form action="main.php?do=contribute_attach_list&feed_id=<?php
echo $_obj['feed_id'];
?>
&p=<?php
echo $_obj['p'];
