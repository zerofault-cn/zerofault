...
<table width="90%" border="1" align="center" cellpadding="20" bordercolor="C1D7F4">
  <tr>
    <td><table width="98%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="10">&nbsp;</td>
        <td width="100" bgcolor="C1D7F4" align="center">添加合作媒体</td>
        <td >&nbsp;</td>
      </tr>
      <tr bgcolor="C1D7F4">
        <td height="1"></td>
...
<table width="80%" border="0" cellspacing="2" cellpadding="10" bgcolor="#c1d7f4" align="center">
  <tr> 
    <td bgcolor="#FFFFFF"> 
      <form action="main.php?do=coop_media_do_modify" name="subject_form" method="post" enctype='multipart/form-data'>
...
?>
" maxlength="20"><?php
echo $_obj['action_error_coopmedia_name'];
?>
...
?>
" maxlength="20"><?php
echo $_obj['action_error_coopmedia_url'];
?>
		  ...
		  <tr bgcolor="#FFFFFF"> 
            ...
            <td> 
              <input name="linkman" type="text" value="<?php
echo $_obj['linkman'];
?>
" maxlength="20"><?php
echo $_obj['action_error_coopmedia_linkman'];
?>
...
?>
" maxlength="20"><?php
echo $_obj['action_error_coopmedia_phone'];
?>
