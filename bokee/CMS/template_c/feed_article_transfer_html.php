...
function validator(){
	var tag = 0;
	var frm = document.form_feed_article_transfer;
...
<form action="main.php?do=feed_article_do_transfer" name="form_feed_article_transfer" method="post" onSubmit="return validator()">
...
?>
	 ...
	 <tr bgcolor="#F0F4FF">
		<td align="center">更改标题</td>
	    <td align="left">
		<input name="rss_article_name" type="text" value="<?php
echo $_obj['rss_article_name'];
?>
" <?php
echo $_obj['rss_article_type'];
?>
 size="40"> (多篇文章不能改标题)
		<input type="hidden" name="rss_article_num" value=<?php
echo $_obj['rss_article_num'];
?>
>
			</td>
	  </tr> 
...
<input type="hidden" name="feed_string" value=<?php
echo $_obj['feed_string'];
?>
>
</form>
</body>
