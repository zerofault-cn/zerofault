...
<form action="main.php?do=user_do_add" name="article_form" method="post" enctype='multipart/form-data'>
...
?>
  ...
  <tr>
    <td nowrap>密码</td>
    <td><input name="password" type="password" id="password" size="20" maxlength="20" value="<?php
echo $_obj['password'];
?>
"> 
    <div class="error"><?php
...
?>
  ...
  <tr>
    <td nowrap>确认密码</td>
    <td><input name="password_re" type="password" id="password_re" size="20" maxlength="20" value="<?php
echo $_obj['password_re'];
?>
"> 
    <div class="error"><?php
echo $_obj['action_error_password_diff'];
?>
</div></td>
  </tr>
  <tr>
...
?>
		...
		<br>
        <INPUT TYPE="checkbox" NAME="chkall" onclick="CheckAll()"> 全选/取消</td>
  </tr>
  <tr>
    <td nowrap>&nbsp;</td>
    <td>&nbsp;</td>
