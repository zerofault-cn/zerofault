...
//$url = 'http://www.blogcn.com/rss.asp?blog=lome';
...
//$title = urlencode("你好");
//$link = urlencode("http://www.bokee.com");
//$url = 'http://211.152.20.34/comment/admin.php?cat_id=1&index_id=1&title=' . $title . '&link=' . $link;
//// Snoopy is an HTTP client in PHP
//$client = new Snoopy();
//$client->agent = 'Mozilla/4.0 (compatible; MSIE 5.00; Windows 98)';
