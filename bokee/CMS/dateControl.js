...
function rightShow(){
parent.WebCalendar.calendar.style.pixelTop -= event.srcElement.offsetHeight +80;
parent.WebCalendar.calendar.style.pixelLeft += event.srcElement.offsetWidth +5;
}

function leftShow(){
parent.WebCalendar.calendar.style.pixelTop -= event.srcElement.offsetHeight +80;
parent.WebCalendar.calendar.style.pixelLeft += event.srcElement.offsetWidth -140;
}
//-->
