...
class FlashXmlDoEditAction extends Action {
	/**
    * 
    * @access public
    * @param array &$request
    ...
    */
    function execute(&$actionMap,&$actionError,$request,&$response,$form){
        ...
        rewind($filepoint); //重置开档的读写位置指针。
       	fputs($filepoint,$str);
           //return "main.php?do=flash_xml_edit&channel_name=$channel_name&id=$id";
...
//        fputs($filepoint,$str3);  
       	$file1 = "/html" . str_replace(PATH_HTML_ROOT, "", $file);
