...
class FlashPicDeleteAction extends Action {
	/**
    * 
    * @access public
    * @param array &$request
    ...
    */
    function execute(&$actionMap,&$actionError,$request,&$response,$form){
		...
		return "main.php?do=flash_edit&channel_name=$channel_name&id=".$request['flash_id'];
