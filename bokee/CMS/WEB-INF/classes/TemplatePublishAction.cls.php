...
class TemplatePublishAction extends Action {
	/**
    * 
    * @access public
    * @param array &$request
    ...
    */
    function execute(&$actionMap,&$actionError,$request,&$response,$form){
		...
		$template->Publish();
		return "main.php?do=template_list&channel_name=$channel_name&subject_id=$subject_id";
	}
}
?>