...
if(''!=$_REQUEST['submit'])
{
	...
	$sql="update user_info set blogname='".$blogname."',blogurl='".$blogurl."',realname='".trim($realname)."',cardtype=".$cardtype.",cardnum='".$cardnum."',addr='".$addr."',post='".$post."',phone='".$phone."',email='".$email."',other='".$other."'".$sqlext." where id=".$id;
