              ...
              <td class="topnav"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#DADCE5">
                  <tr>
                    ...
                    <td  align="right"><span class="mainmenu"><a href="{U_FAQ}" class="mainmenu">{L_FAQ}</a></span><span class="mainmenu">&nbsp;|&nbsp;<a href="{U_SEARCH}" class="mainmenu">{L_SEARCH}</a>&nbsp;|&nbsp;<a href="{U_MEMBERLIST}" class="mainmenu">{L_MEMBERLIST}</a>&nbsp;|&nbsp;<a href="{U_GROUP_CP}" class="mainmenu">{L_USERGROUPS}</a>&nbsp;|&nbsp;<a href="{U_FAV}" class="mainmenu">{L_FAV}</a>
