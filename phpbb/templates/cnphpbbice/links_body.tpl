...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr>
    ...
    <td align="right" style="font-weight: bold;font-size: 11px; color: orange">&#149;&nbsp;<a href="{U_SITE_LINKS}">{LINKS_HOME}</a>&nbsp;&nbsp;&#149;&nbsp;<a href="{U_SITE_SEARCH}">{L_SEARCH_SITE}</a>&nbsp;&nbsp;&#149;&nbsp;<a href="{U_SITE_TOP}">{L_DESCEND_BY_HITS}</a>&nbsp;&nbsp;&#149;&nbsp;<a href="{U_SITE_NEW}">{L_DESCEND_BY_JOINDATE}</a> </td>
  </tr>
</table>
