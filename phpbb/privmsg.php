...
else if ( $mode == 'read' )
{
	...
	//
	$sql = "SELECT u.username AS username_1, u.user_id AS user_id_1, u2.username AS username_2, u2.user_id AS user_id_2, u.user_sig_bbcode_uid, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_skype, u.user_viewemail, u.user_rank, u.user_sig, u.user_avatar, pm.*, pmt.privmsgs_bbcode_uid, pmt.privmsgs_text
	...
	if ( !empty($privmsg['user_skype']) )
 	{
	 	$skype_img = ( $privmsg['user_skype'] ) ? '<a href="callto://' . $privmsg['user_skype'] . '" skype="1"><img src="' . $images['icon_skype'] . '" alt="' . $lang['SKYPE'] . '" title="' . $lang['SKYPE'] . '" border="0" /></a>' : '';
	 	$skype = $skype_img;
 	}
 	else
 	{
