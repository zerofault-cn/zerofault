...
// Version Check
//
$lang['Version_up_to_date'] = '你安装的程序是最新的, 没有可用于你的phpBB的更新.';
$lang['Version_not_up_to_date'] = '你安装的程序<b>不是</b>最新的,请访问 <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> 及时更新.';
$lang['Latest_version_info'] = '最新的版本是 <b>phpBB %s</b>.';
$lang['Current_version_info'] = '你正在使用的是 <b>phpBB %s</b>.'; 
$lang['Connect_socket_error'] = '无法连接到phpBB服务器, 报告错误为:<br />%s';
$lang['Socket_functions_disabled'] = '无法使用 socket 函数.';
$lang['Mailing_list_subscribe_reminder'] = '关于phpBB最新版本更新信息, 请到 <a href="http://www.phpbb.com/support/" target="_new"> 预定我们的邮件通知</a>.';
