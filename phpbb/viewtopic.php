...
for($i = 0; $i < $total_posts; $i++)
{
	...
	if ( $poster_id != ANONYMOUS )
	{
		...
		if ( !empty($postrow[$i]['user_skype']) )
 		{
	 		$skype_img = ( $postrow[$i]['user_skype'] ) ? '<a href="callto://' . $postrow[$i]['user_skype'] . '" skype="1"><img src="http://www.skycall.cn/get_status_pic.php?s=' . $postrow[$i]['user_skype'] . '" alt="' . $lang['SKYPE'] . '" title="' . $lang['SKYPE'] . '" border="0" /></a>' : '';
 		$skype = $skype_img;
 		}
 		else
 		{
